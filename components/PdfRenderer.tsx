...
function PdfRenderer({ url }: PdfRendererProps) {
  ...
  type PageNumber = z.infer<typeof pageValidator>;
  ...
  return (
    <div className="w-full bg-white rounded-md shadow flex flex-col items-center h-full md:min-h-[90vh] ">
      {/* pdf options */}
      <div className="w-full h-18 md:h-14 border-b border-zinc-200 flex items-center justify-between px-2">
        <div className="w-full flex items-center justify-center md:justify-between flex-wrap gap-1 ">
          <div className="flex items-center  justify-center space-x-3">
            <Button
              ...
              onClick={() => {
                ...
                setValue(
                  "page",
                  String(pageNumber - 1 > 1 ? pageNumber - 1 : 1)
                );
              }}
            >
